...
{
	int nn = 0;
	unsigned char  key[] = {  116,84,55,48,109,106,101,77,99,81,120,118,86,73,95,102,49,46,56,54,
					          67,114,78,112,87,121,76,78,70,112,79,102};
...
int myaes_decrypt_key(unsigned char *key, unsigned char *in,unsigned char* out, int len)
{
	int nn = 0;
	#if 0
	unsigned char  key2[] = {
